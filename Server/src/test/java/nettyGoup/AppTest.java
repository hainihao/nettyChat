...
public class AppTest {
    ...
    public static String myEmailAccount = "1452672867@qq.com";
    public static String myEmailPassword = "evwjedksafhahigf";//这个密码不是QQ密码或者邮箱密码，要验证的。自己百度
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1452672867@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 4. Subject: 邮件主题
        message.setSubject("忘记密码，请查看", "UTF-8");
